...
MultipartRequest cr = new MultipartRequest();
    public updateBonplan(BonPlan bp) {
...
TextField Name = new TextField(""+bp.getNom(), "Nom", 20, TextArea.ANY);
TextField Desc = new TextField(""+bp.getDesc(), "Description", 20, TextArea.ANY);
TextField Nbrcp = new TextField(""+bp.getNombredecoupon(), "Nombre de coupon", 20, TextArea.NUMERIC);
        System.out.println(""+bp.getNom());
        
Name.setText(bp.getNom());
Desc.setText(bp.getDesc());
Nbrcp.setText(String.valueOf(bp.getNombredecoupon()));
